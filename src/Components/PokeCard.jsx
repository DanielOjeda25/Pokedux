  ...
  return (
    <div className='flex justify-center dark:border'>
      <div
        ...
        <div className='py-3 px-6 border-b border-gray-300 dark:bg-gray-600 dark:text-white dark:border-slate-500 capitalize'>
          <h2>{name}</h2>
        </div>
        ...
        <div className='py-3 px-6 border-t border-gray-300 text-gray-600  dark:bg-gray-600 dark:text-white dark:border-slate-500 capitalize'>
